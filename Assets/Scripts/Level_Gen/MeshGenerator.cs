...
public static class MeshGenerator
{
    ...
    {
        int skipIncrement =
            (levelOfDetail == 0) ? 1 : levelOfDetail * 2; //Can have a value of 1, 4, 6 or 8
        ...
        for (int y = 0; y < numVertsPerLine; y++)
        {
            for (int x = 0; x < numVertsPerLine; x++)
            {
                ...
                {
                    bool isOutOfMeshVertex = y == 0 || y == numVertsPerLine - 1 || x == 0 || x == numVertsPerLine - 1;
                    bool isMeshEdgeVertex = y == 1 || y == numVertsPerLine - 2 || x == 1 ||
                                            x == numVertsPerLine - 2 && !isOutOfMeshVertex;
...
public class MeshData
{
    ...
    Vector3[] CalculateNormals()
    {
        ...
        int borderTriangelCount = outOfMeshTriangles.Length / 3;
    ...
    Vector3 SurfaceNomalFromIndices(int indexA, int indexB, int indexC)
    {
